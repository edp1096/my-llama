...
<# Compile vendors/llama.cpp - mingw/cmake #>
cd vendors/llama.cpp

mkdir -f build
cd build

cmake .. -G "MinGW Makefiles" -DCMAKE_PREFIX_PATH='../../openclblast' -DLLAMA_CLBLAST=$useCLBlast -DLLAMA_STATIC=1 -DBUILD_SHARED_LIBS=0 -DLLAMA_BUILD_EXAMPLES=0 -DLLAMA_BUILD_TESTS=0
cmake --build . --config Release

cp libllama.a ../../../$libLlamaName
